  ...
  return (
    <div className="bg-[#F8F3D9] min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4">
        <motion.h1
          className="text-4xl text-[#000080] font-bold mb-8"
        ...
        >
          <Card className="mb-8 bg-[#F8F3D9] border-none">
            <CardContent className="p-6">
              ...
              >
                At Everest Souvenir House, we are committed to promoting Nepali craftsmanship and sustainable fashion. Our mission is to provide high-quality, ethically made products while supporting local artisans and preserving traditional techniques.
              </motion.p>
                ...
                {[
                  ...
                  <motion.div key={index} whileHover={{ y: -5 }}>
                    <Card className="bg-[#F8F3D9] border-none">
                      <CardHeader>
                        <CardTitle className="text-[#000080]">{value.title}</CardTitle>
                      </CardHeader>
