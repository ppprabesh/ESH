...
const Slide = ({ slide, index, current, handleSlideClick }: SlideProps) => {
  ...
  return (
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      ...
      >
        <div
          className="absolute rounded-3xl top-0 left-0 w-full h-full bg-[#1D1F2F] overflow-hidden transition-all duration-150 ease-out"
          style={{
            transform:
              current === index
        ...
        >
          {src ? (
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-gray-300 text-black text-sm">
              No Image
            </div>
          )}
